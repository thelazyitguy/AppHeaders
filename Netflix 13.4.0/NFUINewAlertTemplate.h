...
@class MessagingAlert, MessagingAlertInlineView, MessagingDecorationView, MessagingViewController, NFUILabel, NFUILinkLabel, NSLayoutConstraint, NSNumber, NSString, UIImageView, UILabel, UIStackView, UIView;
...
@interface NFUINewAlertTemplate : MessagingAlertTemplate <NFUIProductChoiceViewControllerDelegateProtocol, NFUIModalNavControllerPresentationProtocol>
{
    ...
    UIView *_stackViewBackgroundView;
...
@property(nonatomic) __weak UIStackView *headerStackView; // @synthesize headerStackView=_headerStackView;
...
@property(nonatomic) __weak UIView *stackViewBackgroundView; // @synthesize stackViewBackgroundView=_stackViewBackgroundView;
