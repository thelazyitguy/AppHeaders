...
- (id)offlineRecord;
- (void)dealloc;
- (id)initWithOfflineRecord:(id)arg1 offlineDB:(id)arg2 deactivationQueue:(id)arg3 downloadSession:(id)arg4 delegate:(id)arg5 provider:(id)arg6;
