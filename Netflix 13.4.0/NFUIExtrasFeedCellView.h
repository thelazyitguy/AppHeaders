...
@class NFUIFocusDimOverlay, NFUIIconButton, NFUIImageCarouselView, NFUILabel, NFUIListButton, NFUIMiniPlayerViewController, NFUIShareButton, NFUISimpleTagsView, NFUIStylizedLabel, NFUITitleTreatmentView, NFUIUpdatesEntity, NFUIUpdatesViewModel, NSLayoutConstraint, NSMutableArray, NSString, UIStackView;
...
@interface NFUIExtrasFeedCellView : UIView <UIGestureRecognizerDelegate, NFUIMiniPlayerDelegate, NFUIImageCarouselViewDelegate>
{
    ...
    NSMutableArray *_acessibilityActions;
}

+ (id)new;
+ (id)cachedNib;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *acessibilityActions; // @synthesize acessibilityActions=_acessibilityActions;
...
- (void)fullDescriptionAction:(id)arg1;
- (_Bool)accessibilityActivate;
- (void)myListAction:(id)arg1;
- (void)accessibilityPlayAction:(id)arg1;
- (void)configureCustomActions;
