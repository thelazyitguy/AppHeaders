...
- (void)bredthFirstTraversalFromSegmentId:(NSString *)arg1 maxDepth:(unsigned long long)arg2 usingBlock:(void (^)(id <NFPlaylistSegment>, unsigned long long, _Bool *))arg3;
