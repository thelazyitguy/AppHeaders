...
@class NFIChoiceModel, NFIChoicePointOverlayView, NFICountdownView, NFIModeratorViewController, NFIPlayerNavigatorView, NFISegmentModel, NFUITouchGestureRecognizer, NSArray, NSLayoutConstraint, NSMutableDictionary, NSNumber, NSString, UIView;
...
- (id)segmentWeightOverrides:(id)arg1;
- (id)nextSegmentWeights:(id)arg1;
