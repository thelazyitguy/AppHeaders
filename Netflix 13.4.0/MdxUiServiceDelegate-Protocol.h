...
@class MdxUiConnection, MdxUiPlaySession, MdxUiService, NSDictionary, NSNumber, NSString, PlaybackRequest, UIAlertController, _TtC4Argo21MDXCardViewController;

@protocol MdxUiServiceDelegate <NSObject>

@optional
- (void)mdxUiService:(MdxUiService *)arg1 didRemotelyLoginToTargetNamed:(NSString *)arg2;
...
- (void)mdxUiService:(MdxUiService *)arg1 presentMDXWitcher:(_TtC4Argo21MDXCardViewController *)arg2;
