...
@class CALayer, NFUILabel, NFUINotification, NSLayoutConstraint, NSString, UIButton, UIImageView, UIStackView, UIView;
...
@interface NotificationCell : UITableViewCell <MenuListItemDisplayProtocol>
{
    ...
    CALayer *_artImageViewShadowLayer;
    CALayer *_tileLayer1;
    CALayer *_tileLayer2;
...
@property(retain, nonatomic) CALayer *artImageViewShadowLayer; // @synthesize artImageViewShadowLayer=_artImageViewShadowLayer;
