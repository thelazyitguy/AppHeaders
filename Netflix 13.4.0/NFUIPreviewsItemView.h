...
@class NFUINetworkErrorViewController, NFUIPreviewVideoViewModel, NFUIPreviewsLoadingView, NSString, UILabel, _TtC4Argo24PreviewsPromoOverlayView;
...
@interface NFUIPreviewsItemView : UIView <NFUIPlayerDelegate, NFUINetworkErrorViewControllerDelegate, NFUIReusableVideoViewProtocol>
{
    ...
    double _currentTime;
    _TtC4Argo24PreviewsPromoOverlayView *_promoOverlay;
}

- (void).cxx_destruct;
@property(retain, nonatomic) _TtC4Argo24PreviewsPromoOverlayView *promoOverlay; // @synthesize promoOverlay=_promoOverlay;
