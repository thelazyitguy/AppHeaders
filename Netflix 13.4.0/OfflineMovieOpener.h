...
+ (id)openMovieWithOfflineRecord:(id)arg1 queue:(id)arg2 platformConfig:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void).cxx_destruct;
...
- (void)cancel;
- (void)openMovie;
- (id)initWithOfflineRecord:(id)arg1 queue:(id)arg2 platformConfig:(id)arg3 completion:(CDUnknownBlockType)arg4;
