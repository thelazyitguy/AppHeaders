...
#import <NFManifestAccess/_TtP16NFManifestCommon12NFTextStream_-Protocol.h>

@class NSArray, NSDictionary, NSSet, NSString;
@protocol NFTrack;

@interface TextStreamAccess : StreamAccess <_TtP16NFManifestCommon12NFTextStream_>
{
    NSString *streamTypeIdentifier;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *streamTypeIdentifier; // @synthesize streamTypeIdentifier;
@property(readonly, copy, nonatomic) NSSet *allStreamCdnIdSet;
@property(readonly, copy, nonatomic) NSArray *allStreamUrls;
@property(readonly, copy, nonatomic) NSArray *rankSortedTextCdnInfoArray;
@property(readonly, nonatomic) _Bool isImageBased;
