...
@class NFUIGradientView, NFUIListButton, NFUIPreviewTagsView, NFUIPreviewsSyleButton, NFUIStackButton, NSLayoutConstraint, NSLayoutDimension, UIColor, UIStackView, UIViewPropertyAnimator;
...
@interface NFUIPreviewsOverlayView : UIView
{
    ...
    NFUIPreviewsSyleButton *_playButton;
    NFUIStackButton *_moreInfoButton;
    ...
    NSLayoutDimension *_widthConstraint;
...
@property(retain, nonatomic) NSLayoutDimension *widthConstraint; // @synthesize widthConstraint=_widthConstraint;
...
@property(retain, nonatomic) NFUIStackButton *moreInfoButton; // @synthesize moreInfoButton=_moreInfoButton;
@property(retain, nonatomic) NFUIPreviewsSyleButton *playButton; // @synthesize playButton=_playButton;
...
- (void)renderForPromotionalPreview:(id)arg1;
- (void)renderForStandardPreview;
- (void)completeRenderingViewsAnimated:(_Bool)arg1;
