...
@class LolomoListItemViewModel, LolomoListViewModel, NFUIRenderTimer, NSString, NSTimer, UICollectionView, UIImageView, UIViewController;
@protocol LolomoViewDelegate><LolomoActionDelegate;

@interface LolomoDefaultItemCell : LolomoAbstractEntityItemCell <LolomoItemCell, NFUIRenderTimerDelegateProtocol, NFUICellFactoryItemProtocol, NFUIReusableViewProtocol, NFUICellDisplayProtocol>
{
    _Bool _isLayoutPass;
