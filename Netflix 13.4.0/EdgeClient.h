...
- (id)initWithMslClient:(id)arg1 urlSessionWithHostTranslation:(id)arg2 urlSessionWithoutHostTranslation:(id)arg3 configuration:(id)arg4 userAuthDataProvider:(id)arg5;
