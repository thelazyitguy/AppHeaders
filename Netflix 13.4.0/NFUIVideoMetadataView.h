...
@class NFUILabel, NSLayoutConstraint, NSMutableArray, NSOperationQueue, UIColor;
...
+ (void)configureRatingDictionary:(id)arg1 inMetadataString:(id)arg2 withAttributedString:(id)arg3;
+ (id)stylizedRatingLabel;
+ (void)setStylizedRatingLabel:(id)arg1;
- (void).cxx_destruct;
...
@property(retain, nonatomic) NSMutableArray *accessibilityStrings; // @synthesize accessibilityStrings=_accessibilityStrings;
