...
#import <NFRCW/NSURLSessionDelegate-Protocol.h>

@class NSArray, NSData, NSDate, NSDictionary, NSError, NSHTTPCookieStorage, NSMutableData, NSMutableDictionary, NSMutableURLRequest, NSOperationQueue, NSString, NSTimer, NSURL, NSURLCredential, NSURLRequest, NSURLResponse, NSURLSession, NSURLSessionConfiguration, NSURLSessionTask;
