...
@class LoadingViewController, LoginTextField, LoginViewModel, NFRecaptchaWrapper, NFUIButton, NFUILinkLabel, NSMutableArray, NSString, UINavigationBar, UIScrollView, UIStackView, UITextView, UIView;
...
@interface LoginViewController : BaseLoginViewController <UITextFieldDelegate, LoginViewDelegate>
{
    ...
    NFRecaptchaWrapper *_recaptchaClient;
    NSString *_recaptchaSiteKey;
    ...
    NFUILinkLabel *_recaptchaDisclaimerLabel;
    UITextView *_recaptchaDisclosureTextView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UITextView *recaptchaDisclosureTextView; // @synthesize recaptchaDisclosureTextView=_recaptchaDisclosureTextView;
@property(retain, nonatomic) NFUILinkLabel *recaptchaDisclaimerLabel; // @synthesize recaptchaDisclaimerLabel=_recaptchaDisclaimerLabel;
...
@property(copy, nonatomic) NSString *recaptchaSiteKey; // @synthesize recaptchaSiteKey=_recaptchaSiteKey;
@property(retain, nonatomic) NFRecaptchaWrapper *recaptchaClient; // @synthesize recaptchaClient=_recaptchaClient;
...
- (id)getFormerMemberCopyKeys;
- (id)getNeverMemberCopyKeys;
...
- (void)performLoginWithCredentials:(id)arg1 recaptchaFields:(id)arg2 lastLoginDictionary:(id)arg3;
...
- (void)configureRecaptchaDisclosure;
- (void)configureRecaptchaDisclaimer;
- (void)configureDisplay;
- (void)setupBackButton;
- (void)populateFieldsFromAutoLogin;
- (void)configureRecaptcha;
