...
@class AVContentKeySession, AVPlayer, AVPlayerItem, AVURLAsset, AudioSessionAnnouncer, AudioSubtitleManager, BladeRunnerPlaybackReporter, NSArray, NSDate, NSDictionary, NSError, NSString, NbpImageBasedSubtitleController, OfflineKeyLoaderDelegate, PlaybackAuxiliaryDisplayProvider, TimePitchAlgorithmManager, WatchableInfo;
@protocol NFImageBasedSubtitleController, NfPlaybackAuxiliaryDisplayProvider, NfPlaybackDelegate, OS_dispatch_queue;

@interface OfflinePlayback : NSObject <AVContentKeySessionDelegate, NfSubtitleAudioControllerInternal, NfOfflinePlayback, NfSubtitleAudioController, NfPlaybackLoggingController, AudioSessionAnnouncerDelegate>
{
