...
@interface EdgeRequest : NSObject
{
    _Bool _useFTL;
    _Bool _noRetries;
    _Bool _noURLSessionRetriesEither;
...
+ (_Bool)isIPad;
- (void).cxx_destruct;
@property(nonatomic) _Bool noURLSessionRetriesEither; // @synthesize noURLSessionRetriesEither=_noURLSessionRetriesEither;
...
@property(nonatomic) _Bool useFTL; // @synthesize useFTL=_useFTL;
