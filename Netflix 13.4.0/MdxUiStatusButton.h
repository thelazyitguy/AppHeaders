...
@class NSArray, NSString, UIActivityIndicatorView, UIButton, UIColor, UIImage;
...
@interface MdxUiStatusButton : UIControl <MdxUiMenuViewControllerDelegate>
{
    ...
    _Bool _available;
    _Bool _isHiddenBeforeServiceStartup;
    ...
    UIActivityIndicatorView *_spinnner;
}

+ (id)barButtonItem:(struct CGRect)arg1;
+ (id)buttonWithFrame:(struct CGRect)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) UIActivityIndicatorView *spinnner; // @synthesize spinnner=_spinnner;
...
@property(nonatomic) _Bool isHiddenBeforeServiceStartup; // @synthesize isHiddenBeforeServiceStartup=_isHiddenBeforeServiceStartup;
...
- (void)toggleSpinnerVisibility:(_Bool)arg1;
