...
@property(readonly, copy, nonatomic) NSDictionary *contentAdvisory; // @synthesize contentAdvisory=_contentAdvisory;
...
@property(readonly, copy, nonatomic) NSArray *writers; // @synthesize writers=_writers;
