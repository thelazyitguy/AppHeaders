...
@interface NFUIListButton : NFUIAnimatedButton
{
    ...
    _Bool _doesParentSetIdentifier;
...
@property _Bool didInit; // @synthesize didInit=_didInit;
@property _Bool isUsingLottie; // @synthesize isUsingLottie=_isUsingLottie;
@property(retain, nonatomic) UIColor *fillColor; // @synthesize fillColor=_fillColor;
@property(nonatomic) _Bool doesParentSetIdentifier; // @synthesize doesParentSetIdentifier=_doesParentSetIdentifier;
