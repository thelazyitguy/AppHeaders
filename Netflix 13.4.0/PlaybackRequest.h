...
@interface PlaybackRequest : NFUIPlaybackRequest
{
    ...
    _Bool _displayOnReady;
    _Bool _usePlaygraphForQuickplay;
    NSNumber *_videoId;
    NSURL *_videoURL;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool usePlaygraphForQuickplay; // @synthesize usePlaygraphForQuickplay=_usePlaygraphForQuickplay;
...
@property(nonatomic) _Bool displayOnReady; // @synthesize displayOnReady=_displayOnReady;
