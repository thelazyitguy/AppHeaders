...
- (void)systemKey:(id *)arg1 fromAccount:(id)arg2 key:(id)arg3 storage:(id)arg4;
@property(readonly, nonatomic) NSSet *systemConfigurationKeys;
- (id)storage;
- (_Bool)setStorage:(id)arg1;
...
- (_Bool)setAccountData:(id)arg1 account:(id)arg2;
- (id)reset;
...
- (_Bool)performMigrationFrom:(id)arg1;
- (id)iv;
