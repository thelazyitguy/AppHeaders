...
@class CSLogMetricsProfiler, NCLLogger, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, QoeDataProfiler;
@protocol CSLogDelegateProtocol, DataBrokerDataProviderProtocol, NCLDataDelegate, OS_dispatch_queue;
...
@interface CSLog : NSObject <NCLUploadDelegate, NFLXCrashManagerDelegateProtocol>
{
    ...
    NSNumber *_processStateTransitionStartTime;
    NCLLogger *_logger;
    ...
    NSArray *_disallowedQoeNavigationLevels;
    NSNumber *_doNotLogDebugEvents;
    double _qoeProfileInterval;
    id <NCLDataDelegate> _appDataStore;
}

+ (id)CSTimeFromNSTimeInterval:(double)arg1;
+ (id)clientLog;
- (void).cxx_destruct;
@property(retain, nonatomic) id <NCLDataDelegate> appDataStore; // @synthesize appDataStore=_appDataStore;
@property double qoeProfileInterval; // @synthesize qoeProfileInterval=_qoeProfileInterval;
@property(retain, nonatomic) NSNumber *doNotLogDebugEvents; // @synthesize doNotLogDebugEvents=_doNotLogDebugEvents;
@property(retain, nonatomic) NSArray *disallowedQoeNavigationLevels; // @synthesize disallowedQoeNavigationLevels=_disallowedQoeNavigationLevels;
...
@property(retain, nonatomic) NSNumber *processStateTransitionStartTime; // @synthesize processStateTransitionStartTime=_processStateTransitionStartTime;
...
- (id)pushNavigationWithData:(id)arg1 beforeSessionStart:(CDUnknownBlockType)arg2;
