...
@interface NeroAppFlowController : NSObject <StreamLimitDelegate, NFUIDownloadObserverDelegate, DataBrokerDataProviderProtocol, DeepLinkControllerDelegateProtocol>
{
...
- (struct CGRect)rectForTabOfType:(long long)arg1;
- (id)objectContext;
...
- (void)switchProfileForDeepLink:(id)arg1;
...
- (void)showSearchWithTerm:(id)arg1 suggestionId:(id)arg2 deepLink:(_Bool)arg3;
