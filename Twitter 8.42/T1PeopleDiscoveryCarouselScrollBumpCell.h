...
#import <T1Twitter/T1PeopleDiscoveryScrollBumpCell.h>
...
@interface T1PeopleDiscoveryCarouselScrollBumpCell : T1PeopleDiscoveryScrollBumpCell <TFNLayoutMetricsEnvironment>
{
