...
- (id)initWithDetailsComponent:(id)arg1 isLastComponent:(_Bool)arg2 size:(struct CGSize)arg3 titleFrame:(struct CGRect)arg4 ratingsFrame:(struct CGRect)arg5 subtitleBadgeFrame:(struct CGRect)arg6 subtitleFrame:(struct CGRect)arg7 buttonContainerFrame:(struct CGRect)arg8 isButtonRightColumn:(_Bool)arg9 layoutMetrics:(id)arg10;
