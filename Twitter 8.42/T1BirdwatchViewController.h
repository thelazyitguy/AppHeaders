...
- (id)_t1_rootURLStringForMode:(unsigned long long)arg1 statusId:(long long)arg2 account:(id)arg3;
...
- (void)viewDidLoad;
- (id)initWithAccount:(id)arg1 statusId:(long long)arg2 mode:(unsigned long long)arg3;
