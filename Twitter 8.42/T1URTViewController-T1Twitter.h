...
@interface T1URTViewController (T1Twitter) <T1TimelineMessageEntryTableRowAdapterDelegate, T1UpdateIndicatorDelegate, T1FeedbackActionProvider, T1DataViewControllerRenderPerformanceLoggerDataSource, T1AmbientNotificationDelegate>
