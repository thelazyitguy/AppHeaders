...
@class NSLayoutConstraint, NSString, NSTimer, T1AmbientNotificationContainer, T1VoiceTrackViewModel, T1VoiceView, TAVPlaybackState, TFNBarProgressView, TFNButton, UIButton, UILabel, UIPanGestureRecognizer, UIStackView, UIView;
